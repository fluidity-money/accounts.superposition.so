...
type ComplexityRoot struct {
	...
	Statistics struct {
		...
		AvgGasLimit24Hours func(childComplexity int) int
		AvgGasLimitAllTime func(childComplexity int) int
		AvgGasLimitWeek    func(childComplexity int) int
		Tx24Hours          func(childComplexity int) int
		TxAllTime          func(childComplexity int) int
		TxWeek             func(childComplexity int) int
	}
}
...
func (e *executableSchema) Complexity(ctx context.Context, typeName, field string, childComplexity int, rawArgs map[string]any) (int, bool) {
	...
	case "Mutation.claimRewards":
		...
		return e.ComplexityRoot.Mutation.ClaimRewards(childComplexity, args["markets"].([]string), args["msTs"].(string), args["dryrun"].(*bool)), true
	case "Mutation.createAccountExec":
		if e.ComplexityRoot.Mutation.CreateAccountExec == nil {
			break
		}
	...
	case "Mutation.ninelivesMint":
		...
		return e.ComplexityRoot.Mutation.NinelivesMint(childComplexity, args["mint"].(model.Mint), args["dryrun"].(*bool)), true
	case "Mutation.requestSecret":
		if e.ComplexityRoot.Mutation.RequestSecret == nil {
			break
		}
		...
		return e.ComplexityRoot.Mutation.RequestSecret(childComplexity, args["eoa_addr"].(string), args["nonce"].(int32), args["sigV"].(int32), args["sigR"].(string), args["sigS"].(string), args["dryrun"].(*bool)), true

	case "Query.eoaForAddress":
		if e.ComplexityRoot.Query.EoaForAddress == nil {
			break
		}
		...
		return e.ComplexityRoot.Query.EoaForAddress(childComplexity, args["address"].(string)), true
	case "Query.hasCreated":
		if e.ComplexityRoot.Query.HasCreated == nil {
			break
		}

		args, err := ec.field_Query_hasCreated_args(ctx, rawArgs)
		if err != nil {
			return 0, false
		}

		return e.ComplexityRoot.Query.HasCreated(childComplexity, args["address"].(string)), true

	case "Query.publickey":
		if e.ComplexityRoot.Query.Publickey == nil {
			break
		}

		return e.ComplexityRoot.Query.Publickey(childComplexity), true
	case "Query.statistics":
		if e.ComplexityRoot.Query.Statistics == nil {
			break
		}

		return e.ComplexityRoot.Query.Statistics(childComplexity), true

	case "Statistics.action":
		if e.ComplexityRoot.Statistics.Action == nil {
			break
		}

		return e.ComplexityRoot.Statistics.Action(childComplexity), true
	case "Statistics.avgGasLimit24Hours":
		if e.ComplexityRoot.Statistics.AvgGasLimit24Hours == nil {
			break
		}

		return e.ComplexityRoot.Statistics.AvgGasLimit24Hours(childComplexity), true
	case "Statistics.avgGasLimitAllTime":
		if e.ComplexityRoot.Statistics.AvgGasLimitAllTime == nil {
			break
		}

		return e.ComplexityRoot.Statistics.AvgGasLimitAllTime(childComplexity), true
	case "Statistics.avgGasLimitWeek":
		if e.ComplexityRoot.Statistics.AvgGasLimitWeek == nil {
			break
		}

		return e.ComplexityRoot.Statistics.AvgGasLimitWeek(childComplexity), true
	case "Statistics.tx24Hours":
		if e.ComplexityRoot.Statistics.Tx24Hours == nil {
			break
		}

		return e.ComplexityRoot.Statistics.Tx24Hours(childComplexity), true
	case "Statistics.txAllTime":
		if e.ComplexityRoot.Statistics.TxAllTime == nil {
			break
		}

		return e.ComplexityRoot.Statistics.TxAllTime(childComplexity), true
	case "Statistics.txWeek":
		if e.ComplexityRoot.Statistics.TxWeek == nil {
			break
		}

		return e.ComplexityRoot.Statistics.TxWeek(childComplexity), true
...
func (ec *executionContext) _Query_hasCreated(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		ctx,
		ec.OperationContext,
		field,
...
func (ec *executionContext) _Statistics_action(ctx context.Context, field graphql.CollectedField, obj *model.Statistics) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		ctx,
		ec.OperationContext,
		field,
...
func (ec *executionContext) unmarshalInputFromArgs(ctx context.Context, obj any) (model.FromArgs, error) {
	...
	fieldsInOrder := [...]string{"token", "to_take", "max_unspent"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
		...
		case "token":
			...
			it.Token = data
		case "to_take":
			ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("to_take"))
			data, err := ec.unmarshalNString2string(ctx, v)
			if err != nil {
				return it, err
			}
			it.ToTake = data
		case "max_unspent":
			ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("max_unspent"))
			data, err := ec.unmarshalNString2string(ctx, v)
			if err != nil {
				return it, err
			}
...
func (ec *executionContext) unmarshalInputSolveArgs(ctx context.Context, obj any) (model.SolveArgs, error) {
	...
	fieldsInOrder := [...]string{"permit", "from", "target", "cd", "ms_ts"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
		...
		case "permit":
			ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("permit"))
			data, err := ec.unmarshalNPermit2ᚕᚖgithubᚗcomᚋfluidityᚑmoneyᚋaccountsᚗsuperpositionᚗsoᚋgraphᚋmodelᚐPermitᚄ(ctx, v)
			if err != nil {
				return it, err
			}
			it.Permit = data
		case "from":
			...
			data, err := ec.unmarshalNFromArgs2ᚕᚖgithubᚗcomᚋfluidityᚑmoneyᚋaccountsᚗsuperpositionᚗsoᚋgraphᚋmodelᚐFromArgsᚄ(ctx, v)
			if err != nil {
				return it, err
			}
			it.From = data
		case "target":
			...
			it.Target = data
		case "cd":
			ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("cd"))
			data, err := ec.unmarshalNString2string(ctx, v)
			if err != nil {
				return it, err
			}
	...
	for i, field := range fields {
		...
		case "hasCreated":
			...
			innerFunc := func(ctx context.Context, fs *graphql.FieldSet) (res graphql.Marshaler) {
				...
				res = ec._Query_hasCreated(ctx, field)
				if res == graphql.Null {
					atomic.AddUint32(&fs.Invalids, 1)
				}
				return res
...
func (ec *executionContext) _Statistics(ctx context.Context, sel ast.SelectionSet, obj *model.Statistics) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "action":
			out.Values[i] = ec._Statistics_action(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				out.Invalids++
			}
		case "avgGasLimit24Hours":
			out.Values[i] = ec._Statistics_avgGasLimit24Hours(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				out.Invalids++
			}
		case "avgGasLimitWeek":
			out.Values[i] = ec._Statistics_avgGasLimitWeek(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				out.Invalids++
			}
		case "avgGasLimitAllTime":
			out.Values[i] = ec._Statistics_avgGasLimitAllTime(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				out.Invalids++
			}
		case "tx24Hours":
			out.Values[i] = ec._Statistics_tx24Hours(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				out.Invalids++
			}
		case "txWeek":
			out.Values[i] = ec._Statistics_txWeek(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				out.Invalids++
			}
		case "txAllTime":
			out.Values[i] = ec._Statistics_txAllTime(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				out.Invalids++
			}
		default:
...
func (ec *executionContext) unmarshalNFromArgs2ᚕᚖgithubᚗcomᚋfluidityᚑmoneyᚋaccountsᚗsuperpositionᚗsoᚋgraphᚋmodelᚐFromArgsᚄ(ctx context.Context, v any) ([]*model.FromArgs, error) {
	...
	for i := range vSlice {
		...
		res[i], err = ec.unmarshalNFromArgs2ᚖgithubᚗcomᚋfluidityᚑmoneyᚋaccountsᚗsuperpositionᚗsoᚋgraphᚋmodelᚐFromArgs(ctx, vSlice[i])
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) unmarshalNFromArgs2ᚖgithubᚗcomᚋfluidityᚑmoneyᚋaccountsᚗsuperpositionᚗsoᚋgraphᚋmodelᚐFromArgs(ctx context.Context, v any) (*model.FromArgs, error) {
	res, err := ec.unmarshalInputFromArgs(ctx, v)
	return &res, graphql.ErrorOnPath(ctx, err)
}
...
func (ec *executionContext) unmarshalNPermit2ᚕᚖgithubᚗcomᚋfluidityᚑmoneyᚋaccountsᚗsuperpositionᚗsoᚋgraphᚋmodelᚐPermitᚄ(ctx context.Context, v any) ([]*model.Permit, error) {
	...
	for i := range vSlice {
		ctx := graphql.WithPathContext(ctx, graphql.NewPathWithIndex(i))
		res[i], err = ec.unmarshalNPermit2ᚖgithubᚗcomᚋfluidityᚑmoneyᚋaccountsᚗsuperpositionᚗsoᚋgraphᚋmodelᚐPermit(ctx, vSlice[i])
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) marshalNStatistics2ᚖgithubᚗcomᚋfluidityᚑmoneyᚋaccountsᚗsuperpositionᚗsoᚋgraphᚋmodelᚐStatistics(ctx context.Context, sel ast.SelectionSet, v *model.Statistics) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			graphql.AddErrorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) marshalOStatistics2ᚕᚖgithubᚗcomᚋfluidityᚑmoneyᚋaccountsᚗsuperpositionᚗsoᚋgraphᚋmodelᚐStatisticsᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Statistics) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	ret := graphql.MarshalSliceConcurrently(ctx, len(v), 0, false, func(ctx context.Context, i int) graphql.Marshaler {
		fc := graphql.GetFieldContext(ctx)
		fc.Result = &v[i]
		return ec.marshalNStatistics2ᚖgithubᚗcomᚋfluidityᚑmoneyᚋaccountsᚗsuperpositionᚗsoᚋgraphᚋmodelᚐStatistics(ctx, sel, v[i])
	})
